          ...
          <div className={styles.div}>
            ...
            <form onSubmit={handleLogin} className={styles.logInForm}>
              <input
                ...
                onChange={(e) =>
                  setDetails((prev) => ({ ...prev, lemail: e.target.value }))
                }
              />
              <input
                type="password"
                ...
                onChange={(e) =>
                  setDetails((prev) => ({ ...prev, lpassword: e.target.value }))
                }
              />
              <input
                type="submit"
            ...
            <Link href="/client/forgot" className={styles.forgotLink}>
              Forgot password
            </Link>

            <h1>New user:</h1>
            <Link href="/client/signup" className={styles.signUpLink}>
              Sign Up
            </Link>
          </div>
        </>
